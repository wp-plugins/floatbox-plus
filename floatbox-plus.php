...
class floatbox_plus {
    ...
    function __construct() {
        ...
        //$this->video['youtube']['target'] = "<object type=\"application/x-shockwave-flash\" data=\"http://www.youtube.com/v/###VID###\" width=\"" . $this->options['video_width'] . "\" height=\"" . $this->video['youtube']['height'] . "\"><param name=\"movie\" value=\"http://www.youtube.com/v/###VID###\" /><param name=\"autostart\" value=\"true\" /><param name=\"wmode\" value=\"transparent\" /></object><br />";
        ...
        $this->video['youtube']['target'] = '<a href="http://www.youtube.com/v/###VID###&autoplay=1" title="###THING###" class="floatbox" rel="floatbox" rev="width:' . $this->options['video_width'] . ' height:' . $this->video['youtube']['height'] . ' scrolling:no"><img src="###IMAGE###" class="videoplay" width="' . $this->options['video_width'] . '" height="' . $this->video['youtube']['height'] . '" /></a><br />';
        ...
        //$this->video['vimeo']['target'] = "<object type=\"application/x-shockwave-flash\" data=\"http://www.vimeo.com/moogaloop.swf?clip_id=###VID###\" width=\"" . $this->options['video_width'] . "\" height=\"" . $this->video['vimeo']['height'] . "\"><param name=\"movie\" value=\"http://www.vimeo.com/moogaloop.swf?clip_id=###VID###\" /><param name=\"wmode\" value=\"transparent\" /></object><br />";
        $this->video['vimeo']['target'] = '<a href="http://www.vimeo.com/moogaloop.swf?clip_id=###VID###" title="###THING###" class="floatbox" rel="floatbox" rev="width:' . $this->options['video_width'] . ' height:' . $this->video['vimeo']['height'] . ' scrolling:no"><img src="###IMAGE###" class="videoplay" width="' . $this->options['video_width'] . '" height="' . $this->video['vimeo']['height'] . '" /></a><br />';
    ...
    function change_content($content)
    {
        ...
        $pattern['video'][1] = "/\[(youtube|vimeo) ([[:graph:]]+) (nolink)\]/";
        $pattern['video'][2] = "/\[(youtube|vimeo) ([[:graph:]]+) ([[:print:]]+)\]/";
        $pattern['video'][3] = "/\[(youtube|vimeo) ([[:graph:]]+)\]/";
    ...
    function video_callback($match) {
        ...
        $output = str_replace("###IMAGE###", $this->get_videoimage($match[1], $match[2]), $output);
    ...
    function get_videoimage($service, $id) {
        switch($service) {
            case "youtube":
...
$link
            ...
            $image_url_thumb = wp_get_attachment_image($id, $size, true);
            $output .= "
<{$icontag} class='gallery-icon'>
<a href='$image_url'>$image_url_thumb</a>
</{$icontag}>";
