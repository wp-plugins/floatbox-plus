...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo _e('Floatbox Plus','floatbox_plus'); ?></title>
    </head>
		...
		<table border="0" cellpadding="4" cellspacing="0">
			...
			<td>
				...
				<tr>
					...
					<option value="youtubehq">YouTube HQ</option>
                        ...
                        <tr>
                            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Insert video ID:','floatbox_plus'); ?></td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                        ...
                        <tr>
                            <td>
                                <input type="submit" id="portal_insert" name="insert" value="<?php echo _e('Insert','floatbox_plus'); ?>" onclick="lp_checkData(this.form);" />
                            </td>
                            <td align="right"><input type="button" id="portal_cancel" name="cancel" value="<?php echo _e('Cancel','floatbox_plus'); ?>" onclick="tinyMCEPopup.close();" /></td>
                        </tr>
                    </table>
            ...
            <div id="select_panel" class="panel">
                <form name="select_form" action="#">
                    <table border="0" cellpadding="4" cellspacing="0">
                        <tr>
                            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Select video file:','floatbox_plus'); ?></td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>
                        ...
                        <tr>
                            <td><input type="submit" id="select_insert" name="insert" value="<?php echo _e('Insert','floatbox_plus'); ?>" onclick="lp_checkData(this.form);"/>
                            </td>
                            <td align="right"><input type="button" id="select_cancel" name="cancel" value="<?php echo _e('Cancel','floatbox_plus'); ?>" onclick="tinyMCEPopup.close();" /></td>
                        </tr>
                    </table>
            ...
            <div id="upload_panel" class="panel">
                <form name="upload_form" enctype="multipart/form-data" method="post" action="#">
                    <table border="0" cellpadding="4" cellspacing="0">
                        ...
                        <?php } ?>
                        <tr>
                            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Local video file:','floatbox_plus'); ?></td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                        ...
                        <tr>
                            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Title:','floatbox_plus'); ?></td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                        ...
                        <tr>
                            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Description:','floatbox_plus'); ?></td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                        ...
                        <tr>
                            <td><input type="submit" id="upload_insert" name="insert" value="<?php echo _e('Upload','floatbox_plus'); ?>" />
                            </td>
                            <td align="right"><input type="button" id="upload_cancel" name="cancel" value="<?php echo _e('Cancel','floatbox_plus'); ?>" onclick="tinyMCEPopup.close();" /></td>
                        </tr>
                    </table>
